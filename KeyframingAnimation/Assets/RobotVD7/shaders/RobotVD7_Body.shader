...
_Spec("Spec", 2D) = "white" {}
_SpecPow("_SpecPow", Float) = 20
_GlosPow("_GlosPow", Float) = 20
_Reflection("Reflection", Float) = 2
...
float4 Multiply2=_Reflection.xxxx * TexCUBE0;
float4 Multiply3=Tex2D2 * Multiply2;
float4 Add0=Tex2D1 + Multiply3;
float4 Multiply1=Tex2D2 * _GlosPow.xxxx;
float4 Multiply0=Tex2D2 * _SpecPow.xxxx;
